<template>
  <div class="main_footer">
    <div class="main_footer_input">
      ...
      <!--        :minValue="1"-->
      <!--        :require="true"-->
      <!--        :err.sync="countErrHourNum"-->
      <!--        @handleInputValue="handleCountHour"-->
      <!--      />-->
      <!--      <span>台</span>-->
      <div v-for="item in selStationList" :key="item.key">
    ...
    <div class="count_amount">
      <div class="count_amount_outter">
        <div class="count_amount_block count_amount_block_first">
          ...
          <span class="count_amount_block_unit">算力豆/小时</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    handleCountHour(value) {
      this.$emit('handleCountHour', value)
    },
    ...
    handleCountNum(value) {
      ...
      this.$emit('handleCountHour', numsValue.num, numsValue.sid)
    },
